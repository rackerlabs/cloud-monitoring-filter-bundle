...
class MonitoringWithDelegableTest  extends ReposeValveTest {
    ...
    def "When doing the test"() {
        ...
        ""          | "GET"         | "/entities/234/checks/someotherid"  | "200"        | "OK"                       | ['x-auth-token': '123']  | false                 | null                                                                                                 | { return new Response(200, "ok", ["content-type": "application/json"], "{\"uri\":\"devices/123\"}") }
        ""          | "GET"         | "/entities/345/alarms/someotherid"  | "200"        | "OK"                       | ['X-Auth-Token': '234']  | false                 | null                                                                                                 | { return new Response(200, "ok", ["content-type": "application/json"], "{\"uri\":\"devices/123\"}") }
        ""          | "GET"         | "/entities/456"                     | "200"        | "OK"                       | ['X-Auth-Token': '345']  | false                 | null                                                                                                 | { return new Response(200, "ok", ["content-type": "application/json"], "{\"test\":\"data\"}") }
        ""          | "GET"         | "/entities/567"                     | "200"        | "OK"                       | ['x-auth-token': '456']  | false                 | null                                                                                                 | { return new Response(404, "Not Found") }
        ""          | "GET"         | "/entities/678"                     | "200"        | "OK"                       | ['X-Auth-Token': '567']  | false                 | null                                                                                                 | { return new Response(404, "Not Found") }
