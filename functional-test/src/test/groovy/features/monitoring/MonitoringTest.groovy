...
class MonitoringTest  extends ReposeValveTest {
    ...
    def "When doing the test"() {
        ...
        ""          | "GET"         | "/entities/456"                     | "500"        | "Invalid response from monitoring service" | ['X-Auth-Token': '345', "x-roles": 'monitoring:intermediary']                       | { return new Response(200, "ok", ["content-type": "application/json"], "{\"test\":\"data\"}") }
        ""          | "GET"         | "/entities/567"                     | "500"        | "Unknown Error"                            | ['x-auth-token': '456', "x-roles": 'monitoring:intermediary']                       | { return new Response(404, "Not Found") }
        ""          | "GET"         | "/entities/678"                     | "500"        | "Unknown Error"                            | ['X-Auth-Token': '567', "x-roles": 'monitoring:intermediary']                       | { return new Response(404, "Not Found") }
        ""          | "GET"         | "/entities/789"                     | "500"        | "Unknown Error"                            | ['x-auth-token': '678', "x-roles": 'monitoring:intermediary']                       | { return new Response(500, "Internal Server Error") }
        ""          | "GET"         | "/entities/890"                     | "500"        | "Unknown Error"                            | ['X-Auth-Token': '789', "x-roles": 'monitoring:intermediary']                       | { return new Response(500, "Internal Server Error") }
    }
}
