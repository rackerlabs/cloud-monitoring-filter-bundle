...
public class ExtractDeviceIdFilterTest {
    ...
    public void setup() throws Exception {
        ...
        filter = new ExtractDeviceIdFilter(mockConfigService);
    ...
    public void testFilterInitializedDefault() throws Exception {
        ...
        Mockito.verify(mockConfigService).subscribeTo(
                Matchers.eq("ExtractDeviceIdConfig"),
                Matchers.eq("extract-device-id.cfg.xml"),
                argumentCaptor.capture(),
                Matchers.eq(filter),
                Matchers.eq(ExtractDeviceIdConfig.class));

        assertTrue(argumentCaptor.getAllValues().toString().contains("/META-INF/schema/config/extract-device-id.xsd"));
    }
    ...
    public void testFilterInitializedGiven() throws Exception {
        ...
        Mockito.verify(mockConfigService).subscribeTo(
                ...
                Matchers.any(ExtractDeviceIdFilter.class),
                Matchers.eq(ExtractDeviceIdConfig.class));
    }
